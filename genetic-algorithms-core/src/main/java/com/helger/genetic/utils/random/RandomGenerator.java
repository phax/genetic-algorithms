...
{
  private static IRandomGenerator s_aRG = new RandomGeneratorRandom (ThreadLocalRandom.current ());
  ...
  @Nonnull
  @Nonempty
  public static int [] getMultipleUniqueIntsInRange (@Nonnegative final int nCount,
                                                     @Nonnegative final int nMaxValueExcl)
  {
