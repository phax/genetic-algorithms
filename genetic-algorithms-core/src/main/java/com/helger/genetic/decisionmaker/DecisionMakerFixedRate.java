...
/**
 * Do it every n of m calls (modulo).
 *
 * @author Philip Helger
 */
public class DecisionMakerFixedRate implements IDecisionMaker
{
  ...
  {
    ValueEnforcer.isGT0 (nEvery, "Every");
    ValueEnforcer.isGT0 (nOf, "Of");
    ValueEnforcer.isTrue (nEvery <= nOf, "every must be <= than of");
