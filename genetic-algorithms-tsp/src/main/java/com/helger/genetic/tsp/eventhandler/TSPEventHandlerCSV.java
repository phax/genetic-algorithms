...
public class TSPEventHandlerCSV extends EventHandlerCollecting
{
  private final CSVWriter m_aWriter;
  private final TSPFitnessFunction m_aFF;

  public TSPEventHandlerCSV (@Nonnull @WillNotClose final CSVWriter aWriter, @Nonnull final TSPFitnessFunction ff)
  {
    m_aWriter = aWriter;
    m_aFF = ff;
