...
public final class MainTSPRunnerBerlin52BestSeveral extends AbstractFileBasedTSPRunner
{
  public static void main (final String [] args) throws IOException
  {
    ...
    final ICommonsList <TIntList> aDistanceListPerPopulations = new CommonsArrayList <> (nRepeats);
    final ICommonsList <TIntList> aDistanceListBest = new CommonsArrayList <> (nRepeats);
