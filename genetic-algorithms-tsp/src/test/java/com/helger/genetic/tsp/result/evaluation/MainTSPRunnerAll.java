...
public final class MainTSPRunnerAll extends AbstractFileBasedTSPRunner
{
  ...
  private static final ICommonsMap <String, Integer> TSPLIST = new CommonsLinkedHashMap <> ();
                               ...
                               final int nMutationPerc) throws Exception
  {
    ...
    final IEventHandler eh = new EventHandlerCollecting ();
  ...
  {
    final Map <String, ICrossover> cm = new LinkedHashMap <> ();
    ...
    final Map <String, Class <? extends IMutation>> mm = new LinkedHashMap <> ();
    if (false)
    ...
    System.out.println ("  Estimated end time: " +
                        PDTFactory.getCurrentLocalDateTime ().plusSeconds (nEstimatedSeconds));
    ...
    for (final Map.Entry <String, ICrossover> aEntryC : cm.entrySet ())
    {
      ...
      for (final Map.Entry <String, Class <? extends IMutation>> aEntryM : mm.entrySet ())
      {
        ...
        aWCH.writeTo (new File ("data/all/search-" +
                                aEntryC.getKey () +
                                "-" +
                                nCrossoverPerc +
                                "-" +
                                ...
                                (bUseMaxPopulationSize ? "-maxpop" : "") +
                                ".xlsx"));
        System.out.println ("    Took " + Duration.ofMillis (aSW.stopAndGetMillis ()).toString ());
      }
    }
  }
