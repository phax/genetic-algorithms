...
public abstract class AbstractFileBasedTSPRunner
{
  ...
  public static Matrix readTSPFromFile (@Nonnull final IReadableResource aRes, final boolean bRoundDistances)
  {
    ...
    final ICommonsList <String> aLines = StreamHelper.readStreamLines (aRes, StandardCharsets.ISO_8859_1);
    ...
    {
      final ICommonsList <Point2D> aPoints = new CommonsArrayList <> ();
    ...
    if (false)
      ret.print (new PrintWriter (System.out), 6, 1);
    return ret;
  }
}
